    ...
    <div style={{height:'70vh'}} className='w-100 d-flex justify-content-center align-items-center'>
        <div className='d-flex d-flex justify-content-center align-items-center border rounded p-5 w-25 flex-column'>
            ...
            <div className="d-flex mt-5">
              <input type="text" className="form-control" placeholder="enter amount to be incerted!.." onChange={e=>setAmount(e.target.value)}/>
              <button onClick={handleIncrement} className="btn btn-primary ms-3">incriment by amount</button>
            </div>
